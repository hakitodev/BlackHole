...
- Сайт: ивенты по отдельности, эмбед-редактор команд, шоп сервера, ограничения команд
- Высшие модеры / владелец: `/give` `/take` `/eco`, правка экономики и глобального шопа с сайта
...
Логин через Discord, список серверов, слева модули: общие, автороль, автомод, ограничения, магазин сервера, эмбед-редактор команд и каждый ивент отдельно (вход, выход, бан, разбан, кик, сообщения, буст, уровень, автомод).

Сессия лежит в SQLite на 30 дней, после рестарта Render заново логиниться не надо.

Высшие модеры и владелец в шапке видят «Экономика» и «Глобальный шоп».
